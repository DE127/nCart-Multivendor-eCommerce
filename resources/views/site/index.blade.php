...
@section('frontend-content')
                    ...
                    <div class="col-xl-7 m-auto">
                        <div class="gallery_filter d-flex flex-wrap mb_5">
                            ...
                            @foreach ($product_section->categories as $category)
                                <button
                                    data-filter=".{{ $category->id }}">{{ $category->catlangfrontend->name }}</button>
                            @endforeach
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xl-4 col-md-6 {{ $product->category->id }}">
                            <div class="wsus__gallery_item">
                                <div class="wsus__gallery_item_img">
                                    <img src="{{ asset($product->thumbnail_image) }}" alt="gallery"
                                         class="img-fluid w-100">
                                    <ul class="wsus__gallery_item_overlay">
                                        <li><a target="_blank"
                                               href="{{ $product->preview_link }}">{{__('user.Preview')}}</a></li>
                                        <li>
                                            <a href="{{ route('product-detail', $product->slug) }}">{{__('user.Buy Now')}}</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="wsus__gallery_item_text">
                                    ...
                                    <a class="title"
                                       href="{{ route('product-detail', $product->slug) }}">{{ html_decode($product->productlangfrontend->name) }}</a>
                                    <p class="category">{{__('user.By')}}
                                        <span>{{ html_decode($product->author->name) }}</span> {{__('user.In')}} <a
                                            class="category"
                                            href="{{ route('products', ['category' => $product->category->slug]) }}">{{ $product->category->catlangfrontend->name }}</a>
                                    </p>
                                    <ul class="d-flex flex-wrap justify-content-between">
                                        ...
                                        <li>
                                            <span class="download"><i
                                                    class="far fa-download"></i> {{ $sale }} {{__('user.Sale')}}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                        ...
                                                        <div class="col-xl-6 col-md-6">
                                                            <div class="wsus__trending_theme_item">
                                                                <div class="wsus__trending_theme_item_img">
                                                                    <img
                                                                        src="{{ asset($trending_product->thumbnail_image) }}"
                                                                        alt="img"
                                                                        class="img-fluid w-100">
                                                                </div>
                                                                <div class="wsus__trending_theme_item_text">
                                                                    ...
                                                                    <p>
                                                                        <span>{{__('user.By')}}</span> {{ html_decode($trending_product->author->name) }}
                                                                    </p>
                                                                    <ul class="d-flex flex-wrap justify-content-between align-items-center">
                                                                        ...
                                                                        <li>
                                                                            <a href="{{ route('product-detail', $trending_product->slug) }}"><i
    ...
    ==============================-->
        <section class="wsus__galley_2 pt_115 xs_pt_25">
            <div class="container">
                            ...
                            <div class="wsus__gallery_item">
                                ...
                                <div class="wsus__gallery_item_text">
                                    ...
                                    <div class="like_and_sell">
                                        <span class="download"><i
                                                class="fas fa-arrow-to-bottom"></i>{{ $sale }} {{__('user.Sale')}}</span>
                                    </div>
                ...
                <a href="{{ route('products', ['featured' => 1]) }}" class="common_btn">{{__('user.View All')}} <i
                    ...
                    @foreach ($template_section->templates as $template)
                        <div class="col-xl-3 col-md-6">
                            <div class="wsus__template_item">
                                ...
                                <a target="__blank" href="{{ $template->link }}">{{__('user.Learn More')}} <i
                                        class="far fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="row justify-content-between">
                    <div class="col-xl-5 col-md-5">
                        <div class="wsus__download_2_img">
                            <img src="{{ asset($mobile_app->home1_foreground) }}" alt="download"
                                 class="img-fluid w-100">
                        </div>
                    </div>
                            ...
                            <ul class="d-flex flex-wrap">
                                <li>
                                    <a target="__blank" href="{{ $mobile_app->play_store_link }}">
                                        <img src="{{ asset('frontend/images/download_icon_3.jpg') }}" alt="download"
                                             class="img-fluid w-100">
                                    </a>
                                </li>
                                <li>
                                    <a target="__blank" href="{{ $mobile_app->apple_store_link }}">
                                        <img src="{{ asset('frontend/images/download_icon_4.jpg') }}" alt="download"
                                             class="img-fluid w-100">
                                    </a>
                                </li>
                            </ul>
    ...
    @if ($partner_section->visibility)
        ...
        CUSTOMER START
    ==============================-->
        <section class="wsus__customer pt_115 xs_pt_75 mb_120 xs_mb_80"
                 style="background: url({{ asset('frontend/images/customer_bg.jpg') }});">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-8 m-auto">
                        <div class="wsus__section_heading mb_25">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="wsus__go_offer" style="background: url(https://i.ibb.co/pWN05Bf/subs-bg.jpg);">
                            ...
                            <a class="common_btn" href="{{ $partner_section->offer_link }}"
                               target="__blank">{{__('user.Go to Offer page')}}</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="wsus__blog_3">
                                ...
                                <div class="wsus__blog_3_text">
                                    <a class="categori"
                                       href="javascript:;">{{ \Carbon\Carbon::parse($blog->created_at)->format('d M') }}</a>
                                    <a class="title"
                                       href="{{ route('blog', $blog->slug) }}">{{ $blog->bloglanguagefrontend->title }}</a>
