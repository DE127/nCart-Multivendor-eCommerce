      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <a href="{{ route('admin.faq.index') }}" class="btn btn-primary"><i class="fa-duotone fa-lg fa-list"></i> {{__('admin.FAQ')}}</a>
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="lang_list_top">
                          <ul class="lang_list">
                              ...
                              <li><a href="{{ route('admin.faq.edit', ['faq' => $faq->id, 'lang_code' => $language->lang_code]) }}"><i class="fa-duotone fa-lg fa-edit"></i> {{ $language->lang_name }}</a></li>
                              @endforeach
                          </ul>
                      </div>
