...
{{--                            <li><a href="{{ route('admin.product-type.index', ['lang_code' => $language->lang_code]) }}"><i class="fa-duotone fa-lg fa-edit"></i> {{ $language->lang_name }}</a></li>--}}
{{--                            @endforeach--}}
{{--                        </ul>--}}
{{--                    </div>--}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="">{{__('Product Title')}}</label>
