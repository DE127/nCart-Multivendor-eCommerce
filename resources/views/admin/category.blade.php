      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <a href="{{ route('admin.category.create') }}" class="btn btn-primary"><i class="fa-duotone fa-lg fa-xl fa-xl fa-xl fa-xl fa-xl fa-xl fa-xl fa-xl fa-plus"></i> {{__('admin.Add New')}}</a>
            <div class="row mt-4">
                <div class="col">
                  <div class="card">
                    <div class="card-body">
