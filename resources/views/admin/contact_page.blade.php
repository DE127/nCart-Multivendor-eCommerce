                  ...
                  <div class="card-body">
                    ...
                    <div class="lang_list_top">
                        <ul class="lang_list">
                            ...
                            <li><a href="{{ route('admin.contact-us.index', ['lang_code' => $language->lang_code]) }}"><i class="fa-duotone fa-lg fa-xl fa-xl fa-xl fa-xl fa-xl fa-edit"></i> {{ $language->lang_name }}</a></li>
                            @endforeach
                        </ul>
                    </div>
